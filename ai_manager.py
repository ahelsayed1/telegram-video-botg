...
class AIManager:
            ...
            if google_api_key:
                ...
                try:
                    ...
                    preferred_models = [
                        ...
                        'gemini-2.0-flash-lite',  # خيار خفيف وسريع
                        'gemini-1.5-flash',       # الخيار المستقر (القديم)
                        'gemini-1.5-pro',
    ...
    def clean_response(self, text: str) -> str:
        ...
        # إذا كان التنظيف قد مسح كل شيء، نرجع النص الأصلي كما هو
        if not clean_text:
